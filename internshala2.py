...
base_url = "https://internshala.com/internships/work-from-home-jobs/page-{}"
page_num = 1
...
# loop through each page of the website and extract the relevant information
while True:
    ...
    # if there are no more internship listings, break out of the loop
